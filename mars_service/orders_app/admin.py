...
class OrderAdmin(admin.ModelAdmin):
    ...
    # methods to get fields from foreign table for list_display
...
class DeviceInFieldAdmin(admin.ModelAdmin):
    ...
    # Fields name for admin panel
    my_customer.short_description = "Пользователь"
    my_device_model.short_description = "Производитель"
    my_device_manufacturer.short_description = "Модель"
